$(document).ready(function () {
    ...
    $(window).on("scroll load",  ()=> {
        ...
        var gallary = $('.gallery-section').offset().top;
        ...
        $('.Home, .about, .gallery-section, .menu, .contact').each( ()=> {
    ...
    $('body').append('<button class="back-to-top btn btn-dark w-25 m-auto">↑</button>');
    $('.back-to-top').css({position:'fixed', bottom:'30px', right:'30px', display:'none'});
